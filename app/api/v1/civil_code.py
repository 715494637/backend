...
@router.get("", response_model=List[CivilCodeArticleSchema])
...
@router.post("", response_model=CivilCodeArticleSchema)
...
@router.put("/{article_id}", response_model=CivilCodeArticleSchema)
