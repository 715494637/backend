...
class CivilCodeService:
    ...
    @staticmethod
    async def create_civil_code(db: AsyncSession, article_data: CivilCodeArticleCreate) -> CivilCodeArticle:
        """
        创建新的民法典条文
    ...
    @staticmethod
    async def update_civil_code(db: AsyncSession, article_id: str, article_data: CivilCodeArticleCreate) -> CivilCodeArticle:
        """
        更新民法典条文
        ...
        """
        result = await db.execute(select(CivilCodeArticle).where(CivilCodeArticle.id == article_id))
